...
public sealed class Block(int index, 
    ...
    long nonce = 0) : IBlock
{
    ...
    public string MerkleRoot => MerkleTree.ComputeRoot(Transactions);
    ...
    {
        IReadOnlyList<ITransaction> genesisTransactions = [new Transaction(new string('0', 64), "genesis-reward", 50m, true)];
        
        return new Block(0, DateTimeOffset.FromUnixTimeSeconds(1_700_000_000), new string('0', 64), genesisTransactions);
    }
